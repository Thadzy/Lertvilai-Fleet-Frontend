...
function none() {}
function selector_default(selector$10) {
	return selector$10 == null ? none : function() {
		return this.querySelector(selector$10);
	};
}
...
function selectorAll_default(selector$10) {
	return selector$10 == null ? empty : function() {
		return this.querySelectorAll(selector$10);
	};
}
...
function matcher_default(selector$10) {
	return function() {
		return this.matches(selector$10);
	};
}
function childMatcher(selector$10) {
	return function(node) {
		return node.matches(selector$10);
	};
}
...
EnterNode.prototype = {
	...
	querySelector: function(selector$10) {
		return this._parent.querySelector(selector$10);
	},
	querySelectorAll: function(selector$10) {
		return this._parent.querySelectorAll(selector$10);
	}
};
...
function select_default(selector$10) {
	return typeof selector$10 === "string" ? new Selection$1([[document.querySelector(selector$10)]], [document.documentElement]) : new Selection$1([[selector$10]], root);
}
...
var require_use_sync_external_store_shim_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js": ((exports) => {
	(function() {
		...
		var React$2 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState$1 = React$2.useState, useEffect$2 = React$2.useEffect, useLayoutEffect = React$2.useLayoutEffect, useDebugValue$1 = React$2.useDebugValue, didWarnOld18Alpha = !1, didWarnUncachedGetSnapshot = !1, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js": ((exports) => {
	(function() {
		...
		"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
		var React$2 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef$2 = React$2.useRef, useEffect$2 = React$2.useEffect, useMemo$1 = React$2.useMemo, useDebugValue$1 = React$2.useDebugValue;
		exports.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector$10, isEqual) {
			...
			instRef = useMemo$1(function() {
				function memoizedSelector(nextSnapshot) {
					if (!hasMemo) {
						...
						nextSnapshot = selector$10(nextSnapshot);
					...
					var nextSelection = selector$10(nextSnapshot);
...
function useStoreWithEqualityFn(api, selector$10 = identity$2, equalityFn) {
	const slice = useSyncExternalStoreWithSelector(api.subscribe, api.getState, api.getServerState || api.getInitialState, selector$10, equalityFn);
	useDebugValue(slice);
	return slice;
}
var createWithEqualityFnImpl = (createState, defaultEqualityFn) => {
	const api = createStore(createState);
	const useBoundStoreWithEqualityFn = (selector$10, equalityFn = defaultEqualityFn) => useStoreWithEqualityFn(api, selector$10, equalityFn);
...
function getBend(a, b, c, size) {
	...
	if (a.y === y) {
		...
		return `L ${x + bendSize * xDir$1},${y}Q ${x},${y} ${x},${y + bendSize * yDir}`;
	}
		...
		if (d3Selection && d3Zoom) return {
			...
			screenToFlowPosition: (position) => {
				...
				return pointToRendererPoint({
					x: position.x - domX,
					y: position.y - domY
				}, transform$1, snapToGrid, snapGrid);
			},
...
function useReactFlow() {
	...
	const addNodes = (0, import_react.useCallback)((payload) => {
		...
		const { getNodes: getNodes$1, setNodes: setNodes$1, hasDefaultNodes, onNodesChange } = store.getState();
		if (hasDefaultNodes) setNodes$1([...getNodes$1(), ...nodes]);
...
function hasSelector(target, selector$10, nodeRef) {
	let current = target;
	do {
		if (current?.matches(selector$10)) return true;
...
var getHandleBounds = (selector$10, nodeElement, zoom, nodeOrigin) => {
	const handles = nodeElement.querySelectorAll(selector$10);
...
function Viewport({ children: children$1 }) {
	const transform$1 = useStore(selector$3);
	return import_react.createElement("div", {
...
var createRFStore = () => createWithEqualityFn((set$2, get$2) => ({
	...
	setDefaultNodesAndEdges: (nodes, edges) => {
		...
		set$2({
			nodeInternals: hasDefaultNodes ? createNodeInternals(nodes, /* @__PURE__ */ new Map(), get$2().nodeOrigin, get$2().elevateNodesOnSelect) : /* @__PURE__ */ new Map(),
	...
	triggerNodeChanges: (changes) => {
		...
		if (changes?.length) {
			if (hasDefaultNodes) set$2({ nodeInternals: createNodeInternals(applyNodeChanges(changes, getNodes()), nodeInternals, nodeOrigin, elevateNodesOnSelect) });
...
function EdgeLabelRenderer({ children: children$1 }) {
	...
	return (0, import_react_dom.createPortal)(children$1, edgeLabelRenderer);
}
...
function createUseItemsState(applyChanges$1) {
	return (initialItems) => {
		...
		return [
			items,
			setItems,
			(0, import_react.useCallback)((changes) => setItems((items$1) => applyChanges$1(changes, items$1)), [])
		];
	};
}
